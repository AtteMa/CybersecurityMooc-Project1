...
We could start the project with a version of django that has known vulnerabilities.
Django 4.2.1 has a known DoS vulnerability in the django.utils.encoding.uri_to_iri() function.
...
SECRET_KEY = 'django-insecure-_39z#a%_#%p)t6du65enme=@18z^iet=y5g-%tgcv3%e2(xhfy'
